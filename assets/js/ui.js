...
function getPermissionBtn() {
    ...
    if (Notification.permission === "default") {
        ...
        return `
            <div class="w-full mb-3 px-4 py-3 bg-[#3c2525] border border-error/20 rounded-xl text-left">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-error/10 text-error flex items-center justify-center shrink-0">
                        <span class="material-symbols-rounded">notifications_off</span>
                    </div>
                    <div>
                        <h4 class="text-xs font-bold text-[#E3E3E3]">Notifications Blocked</h4>
                        <p class="text-[10px] text-[#C4C7C5]">Enable in browser settings to get alerts</p>
                    </div>
                </div>
            </div>
        `;
